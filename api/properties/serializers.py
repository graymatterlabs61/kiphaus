...
class PropertyListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "avg_rating", "total_reviews", "cancellation_policy",
            "cover_photo", "host_name", "host_phone", "status", "distance_km",
            "verification_level",
        ]
    ...
    def get_verification_level(self, obj):
        from verification.services import approved_level_for
        return approved_level_for(obj.host)
...
class PropertyDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "avg_rating", "total_reviews", "total_bookings", "verification_level",
