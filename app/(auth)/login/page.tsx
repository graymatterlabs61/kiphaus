  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="space-y-4">
        <Button variant="outline" className="w-full rounded-full h-[50px] bg-ring border-ring hover:bg-ash-mist hover:text-ink-black transition-colors font-semibold text-graphite text-body relative shadow-none">
          <svg className="justify-center size-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <Button variant="outline" className="w-full rounded-full h-[50px] bg-transparent border-border hover:bg-ash-mist hover:text-ink-black transition-colors font-semibold text-graphite text-body relative shadow-none">
          <svg className="justify-center size-5" viewBox="0 0 24 24">
